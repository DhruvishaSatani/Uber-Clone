...
const Home = () => {
  return (
    <div>
        <div className="h-screen pt-8 bg-cover bg-bottom bg-center w-full flex justify-between flex-col  bg-[url(https://images.unsplash.com/photo-1619059558110-c45be64b73ae?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] ">
